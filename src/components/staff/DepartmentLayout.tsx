...
export const DepartmentLayout: React.FC<DepartmentLayoutProps> = ({
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="text-center">
          ...
          <p className="text-gray-700 font-semibold text-lg">Loading {departmentName}...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      {/* Department Header */}
      <div className={`bg-gradient-to-r ${colors.header} border-b px-4 py-4 shadow-md`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/90">{staffName}</p>
            </div>
          </div>
      ...
      {/* Main Content */}
      <main className={`flex-1 overflow-y-auto bg-gradient-to-br ${colors.bg}`}>
        {/* Mobile View */}
        ...
        {/* Desktop View */}
        <div className="hidden lg:block w-full min-h-[calc(100vh-200px)] px-6 pb-6 pt-6">
